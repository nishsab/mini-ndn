...
class StatsLogger:
    ...
    def log_stats(self):
        ...
        event_counts = self.count_events(files)
        print("event counts: {}".format(event_counts))
        state_vector_stats = self.assess_state_vector(files)
    ...
    def assess_state_vector(self, files):
        last_state_vector = {}
