...
class SvsChatApplication(Application):
    ...
    def start(self):
        ...
        run_cmd = "/home/ubuntu/ndn-shared/src/copy_of_svs/ndn-svs/build/examples/chat {} &".format(identity)
        info("[{}] Running {}\n".format(self.node.name, run_cmd))
        self.node.cmd(run_cmd)
...
class IdentityApplication(Application):
    ...
    """
    def __init__(self, node, key_dir="/home/ubuntu/ndn-shared/src/local-ndn-svs/ndn-svs/example-security"):
        Application.__init__(self, node)
